...
<head>
    ...
    <nav style="    background-color: #e5e7e221;" class="navbar navbar-expand-lg  p-4">
        ...
        <div class="collapse navbar-collapse" id="button">
            ...
            <ul style="    margin: auto;" class="navbar-nav mr-auto mt-2 mt-lg-0">
                ...
                <?php if(auth()->guard()->guest()): ?>
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(route('login')); ?>">Sigin</a>
                    </li>
                <?php endif; ?>
                ...
                <?php if(Auth::check() && Auth::user()->type === 'admin'): ?>
                    <li><a href="<?php echo e(route('dashboard.show')); ?>" class="nav-link">Admin Dashboard</a></li>
        ...
        <div><a href="<?php echo e(route('cart.index')); ?>" class=""
                ...
                <sup class=""><?php echo e(count((array)session('cart'))); ?></sup>
            </a>
            <a href="/profile">
...
<?php /**PATH C:\xampp\htdocs\e-commerce\resources\views/layout.blade.php ENDPATH**/ ?>