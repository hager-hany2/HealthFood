...
<?php $__env->startSection('content'); ?>
    ...
    <main style="  background-color: #f3f2f2;">
        <div class="box">
            <div class="inner-box Admin ">
                <div class="forms-wrap ">
                    <form action="<?php echo e(route('AddServices.save')); ?>" method="POST" autocomplete="off" class="sign-in-form">
                        <?php echo csrf_field(); ?>
                        <div class="logo">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <input type="submit" value="Add Services" class="sign-btn"/>
...
<?php echo $__env->make('LayoutAdmin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\e-commerce\resources\views/Admin/AddServices.blade.php ENDPATH**/ ?>