        ...
        <div class="box">
            <div class="inner-box contact_us">
                <div class="forms-wrap">
                    <form method="post" action="<?php echo e(route('contact.save')); ?>" autocomplete="off" class="sign-in-form">
                        <?php echo csrf_field(); ?>
                        <div class="logo">
...
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                            <p style="    position: relative;top: -24px;" class=" text-danger"><?php echo e($message); ?></p>
                            <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
                            <div class="input-wrap">
                                ...
                                <textarea placeholder="Message" class="input-field" name="info"
                                          value="<?php echo e(old('info')); ?>"><?php echo e(old('info')); ?></textarea>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\e-commerce\resources\views/contactus.blade.php ENDPATH**/ ?>