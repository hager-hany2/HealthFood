<?php $__env->startSection('title', 'Sign in & Sign up Form'); ?>
    ...
    <div class="box">
        <div class="inner-box">
            <div class="forms-wrap">
                <form action="<?php echo e(route('login.save')); ?>" method="POST" autocomplete="off"
                      class="sign-in-form">
                    <?php echo csrf_field(); ?>
                    <div class="logo">
                    ...
                    <div class="actual-form">
                        ...
                        if ($__bag->has($__errorArgs[0])) :
                            ...
                            <p style="    position: relative;top: -24px;"
                               class=" text-danger m-1"><?php echo e($message); ?></p>
                            <?php unset($message);
                        ...
                        <?php if ($errors->any()): ?>
                            ...
                            foreach ($__currentLoopData as $err): $__env->incrementLoopIndices();
                ...
                <form action="" method="POST" autocomplete="off" class="sign-up-form">
                    ...
                    <div class="heading">
                        ...
                        <a href="<?php echo e(route('Register')); ?>" class="toggle">Sign in</a>
                    </div>
                    ...
                    <div class="actual-form">
                        ...
                        unset($__errorArgs, $__bag); ?>
                        <input type="submit" value="sigup" class="sign-btn"/>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\e-commerce\resources\views/sigin.blade.php ENDPATH**/ ?>
