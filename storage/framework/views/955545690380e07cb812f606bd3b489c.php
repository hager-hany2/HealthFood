        ...
        <div class="box">
            <div class="inner-box Admin ">
                <div class="forms-wrap ">
                    <form action="<?php echo e(route('Admin.save')); ?>" method="POST" autocomplete="off" class="sign-in-form"
...
<?php echo $__env->make('LayoutAdmin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\e-commerce\resources\views/Admin/AddAdmin.blade.php ENDPATH**/ ?>